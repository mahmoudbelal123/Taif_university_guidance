package mab.taif_university_guidance.model.admin.college;
...
public class WebAddCollegeModel {

    private RequestQueue queue;
    private StringRequest requestString;

    public void addCollege(final Context context, final String name, final String description ,final String id_user, final RequestInterface requestInterface)
    {
...

        {
            ...
            protected java.util.Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put(College.NAME, name);
                params.put(College.DESCRIPTION, description);
                params.put(College.ID_USER, id_user);
                params.put(TAGS.TAG,TAGS.ADMIN_ADD_COLLEGE );
