...
public class WebGetAllCollegesModel {

    private RequestQueue queue;
    private StringRequest requestString;

    public void getAllColleges(final Context context, final RequestInterface requestInterface)
    {
...

        {
            ...
            protected java.util.Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put(TAGS.TAG,TAGS.ADMIN_GET_ALL_COLLEGES );
