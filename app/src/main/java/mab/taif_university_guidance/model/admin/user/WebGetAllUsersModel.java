...
public class WebGetAllUsersModel {

    private RequestQueue queue;
    private StringRequest requestString;

    public void getAllUsers(final Context context, final RequestInterface requestInterface)
    {
...

        {
            ...
            protected java.util.Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put(TAGS.TAG,TAGS.GET_ALL_USERS );
