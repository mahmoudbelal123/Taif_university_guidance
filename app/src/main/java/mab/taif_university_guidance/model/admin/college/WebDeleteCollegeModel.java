...
public class WebDeleteCollegeModel {


    private RequestQueue queue;
    private StringRequest requestString;

    public void deleteCollege(final Context context, final String id_college, final RequestInterface requestInterface)
    {
...

        {
            ...
            protected java.util.Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put(College.ID_COLLEGE, id_college);
                params.put(TAGS.TAG,TAGS.ADMIN_DELETE_COLLEGE );
