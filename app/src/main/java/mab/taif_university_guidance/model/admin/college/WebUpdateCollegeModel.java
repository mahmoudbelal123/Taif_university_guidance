...
public class WebUpdateCollegeModel {

    private RequestQueue queue;
    private StringRequest requestString;

    public void updateCollege(final Context context, final String name, final String description,final String id_College  , final String id_user, final RequestInterface requestInterface)
    {
...

        {
            ...
            protected java.util.Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put(TAGS.TAG,TAGS.ADMIN_UPDATE_COLLEGE );
