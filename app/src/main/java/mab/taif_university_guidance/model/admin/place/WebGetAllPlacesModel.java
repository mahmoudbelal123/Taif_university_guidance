...
public class WebGetAllPlacesModel {

    private RequestQueue queue;
    private StringRequest requestString;

    public void getAllPlaces(final Context context, final RequestInterface requestInterface)
    {
...

        {
            ...
            protected java.util.Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put(TAGS.TAG,TAGS.GET_PLACES );
