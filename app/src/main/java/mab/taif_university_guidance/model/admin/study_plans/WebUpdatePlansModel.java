...
public class WebUpdatePlansModel {

    private RequestQueue queue;
    private StringRequest requestString;

    public void updatePlan(final Context context, final String idPlan,final String newNamePlan,final String newDescriptionPlan, final RequestInterface requestInterface)
    {
...

        {
            ...
            protected java.util.Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put(Plans.PLAN_NAME,newNamePlan );
                params.put(Plans.PLAN_DESCRIPTION,newDescriptionPlan );
                params.put(TAGS.TAG,TAGS.UPDATE_PLANS );
