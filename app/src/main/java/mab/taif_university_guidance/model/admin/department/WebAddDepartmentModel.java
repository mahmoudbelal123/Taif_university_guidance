...
public class WebAddDepartmentModel {

    private RequestQueue queue;
    private StringRequest requestString;

    public void addDepartment(final Context context, final String name, final String description ,final String id_college,final String id_user,final String id_study_plan, final RequestInterface requestInterface)
    {
...

        {
            ...
            protected java.util.Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put(TAGS.TAG,TAGS.ADMIN_ADD_DEPARTMENT );
