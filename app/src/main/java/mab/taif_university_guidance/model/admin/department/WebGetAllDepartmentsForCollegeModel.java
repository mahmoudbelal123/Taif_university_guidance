...
public class WebGetAllDepartmentsForCollegeModel {

    private RequestQueue queue;
    private StringRequest requestString;

    public void getAllDepartmentsForCollege(final Context context,final String id_college, final RequestInterface requestInterface)
    {
...

        {
            ...
            protected java.util.Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put(TAGS.TAG,TAGS.ADMIN_GET_ALL_DEPARTMENTS_FOR_COLLEGE );
